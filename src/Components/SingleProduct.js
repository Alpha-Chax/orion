      ...
      <div className="row py-4 col-md-14">
        ...
        {product.map((element) => {
          return (
            ...
            <NavLink className="btn btn-outline-dark mx-4 px-3 py-2" to="/cart">Go To Cart</NavLink>
            <button className="btn btn-outline-dark px-3 py-2" onClick={handleAddProduct}>Add To Cart</button>
            </div> 
            </>
          );
        })}    
